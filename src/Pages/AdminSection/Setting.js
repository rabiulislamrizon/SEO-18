                                ...
                                <div class="container text-center mb-5">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3  col-md-6 col-12">
                                            ...
                                            <div className='single-card'>
                                                <Link to='/edit-testimonial'>  <img src={testimonial} /><h6>Testimonial Setting</h6> </Link>
                                            </div>
                                        </div>
                                        <div class="col-lg-3  col-md-6 col-12">
                                            <div className='single-card'>
                                                <Link to='/add-address-footer'> <img src={footerad} /> <h6>Footer Address Setting</h6></Link>
                                            </div>
                                        </div>
                                        <div class="col-lg-3  col-md-6 col-12">

                                            <div className='single-card'>
                                                <Link to='/add-social-footer'> <img src={footersocial} /> <h6>Footer About Setting</h6> </Link>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3  col-md-6 col-12">
                                            ...
                                            <div className='single-card'>
                                                <Link to='/add-copyright'> <img src={copyright} /> <h6>Footer Copy Right Setting</h6> </Link>
                                            </div>
                                        </div>
                                        <div class="col-lg-3  col-md-6 col-12">

                                            <div className='single-card'>
                                                <Link to='/add-user'> <img src={mail} /> <h6>Admin User Setting</h6> </Link>
                                            </div>
                                        </div>
