                    ...
                    <div className="row d-flex justify-content-center">
                        <form className="contact-form mt-5" onSubmit={handleTicket}>
                            <div className="row justify-content-center">
                                ...
                                <div className="col-12 mb-3">
                                    <div className="form-group">
                                        <input type="text" className="form-control"  name="ticketId" placeholder="Ticket Id Name" required />
                                    </div>
                                </div>
                                <div className="col-12 mb-3">
                                    <div className="form-group">
                                ...
                                <div className="slider-btn d-flex justify-content-center">
                                    <button className="default-btn" data-animation="fadeInRight" data-delay=".8s">Ticket Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
